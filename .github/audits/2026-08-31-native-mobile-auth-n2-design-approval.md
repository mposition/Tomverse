...
- **기준 HEAD (rev.4): `94e9e94`** — rev.3은 `af06a99`, rev.2는 `49c2624`/`ffca693`, rev.1은 `1ee7793`/`7a1dd05`
...
**A안 승인에 필수인 것과 아닌 것 *(rev.4)*.** A를 고르면 위 목록 중
**17·18은 A안 승인의 필수 항목이 아닙니다** — 17은 A가 쓰지 않는 기전이고,
18은 이 저장소의 다른 경로에 대한 별도 작업입니다. **6번은 남습니다**: N2 자신의
취소 관측 상한과 그것을 참으로 만드는 D12의 1~3은 A안에서도 그대로 필요합니다.
나머지(1~5, 7~16)는 A안 여부와 무관하게 승인 대상입니다.
