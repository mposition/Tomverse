...
Ctrl-C 어디서든. 비밀이 아닌 넷(id·issuer·audience·은퇴 목록)은 평범한 인수로 남겼고,
...
| **§2.2의 (a)/(b)/(c) 결정** | **활성화의 선결 조건.** 회전은 현재 링의 평문을 요구하는데 sealed 값은 그것을 돌려주지 않습니다. 정해지지 않으면 첫 설정은 되고 **두 번째 회전이 안 됩니다** |
