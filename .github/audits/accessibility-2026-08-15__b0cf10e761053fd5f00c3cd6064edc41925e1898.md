...
```
Release SHA: b0cf10e761053fd5f00c3cd6064edc41925e1898
...
| 14 | Real browser zoom 200% | `/`, `/pricing`, chat | No horizontal scroll, nothing clipped | 세 페이지 모두 가로 스크롤 없음, 잘림 없음 | Chrome 141, 2026-08-15 | 통과 |
| 15 | Real browser zoom 400% | As #14 | As above | 400%에서 / · /pricing · /chat 모두 페이지 가로 스크롤 없음 | Chrome 141, 2026-08-15 | 통과 |
| 16 | Windows High Contrast (real, not emulated) | Consent, picker, send, error | Controls and focus remain visible | (보신 내용) | Windows 11 수맥 테마, Chrome 141, 2026-08-15 | 통과 |
