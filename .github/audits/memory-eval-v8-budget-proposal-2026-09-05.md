...
```
schema JSON        1,061자  ≈ 281 tokens (name·strict 포함)
...
```
회차당 US$6.56   = ceil(6.5574902)     evalBudget.maxUsd
2회   US$13.12   = 6.56 × 2            programmeMaxMicroUsd: 13_120_000
```
...
사람의 것**입니다. 제가 조용히 얹지 않았습니다. 얹는다면 그것은 이 문서가
계산한 값이 아니라 별도의 결정으로 기록돼야 합니다.
...
evalBudget: {
    ...
    maxUsd: 6.56,
    programmeMaxMicroUsd: 13_120_000,
    ticket:
