...
export default function AdminError({
  ...
  return (
    <div className="rounded-2xl border border-red-500/30 bg-red-500/10 p-6">
      ...
      <button type="button" onClick={() => unstable_retry()} className="mt-4 inline-flex items-center gap-2 rounded-xl border border-red-400/30 bg-red-500/10 px-4 py-2 text-sm font-bold text-red-100 hover:bg-red-500/20"><RefreshCw className="h-4 w-4" /> Try again</button>
    </div>
  );
}
