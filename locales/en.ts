export const en = {
    ...
    usage: {
        ...
        proResponsesMonth: "Pro-model responses this month",
    ...
    auth: {
        ...
        planPolicyGuest: "Guest: 100 monthly credits, 20 daily credits, Free models only, no attachments.",
        planPolicyFree: "Free: 300 monthly credits, 30 daily credits, and up to 30 Pro-model responses per month.",
        planPolicyPro: "Pro: 3,000 monthly credits, 150 daily credits, all model tiers, with weighted high-cost usage. Regular price $15/month.",
        planPolicyMax: "Max: 8,000 monthly credits, no daily credit guardrail, plus fair-use and provider cost protection. Regular price $25/month.",
