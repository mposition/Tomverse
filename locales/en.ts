export const en = {
    ...
    chat: {
        ...
        maxGuestModelCompare: "Guest mode can compare up to 2 models.",
        ...
        maxGuestModelsDescription: "Guest comparison up to 2 models",
    ...
    billing: {
        joinWaitlist: "Use promo code TOMVERSE50",
        sending: "Sending...",
    ...
    auth: {
        ...
        billingComingSoon: "Use promo code TOMVERSE50 for 50% off your first 3 months",
