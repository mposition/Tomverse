export const en = {
    ...
    billing: {
        ...
        sending: "Sending...",
        waitlistSent: "Waitlist request received.",
        waitlistFailed: "Could not join the waitlist.",
        joinProWaitlist: "Join Pro waitlist",
        joinMaxWaitlist: "Join Max waitlist",
    },
    modelTags: {
        general: "General",
        files: "Files",
    ...
    auth: {
        ...
        planPolicyPro: "Pro: all model tiers with higher usage limits.",
        planPolicyMax: "Max: all model tiers with no daily message limit.",
    },
    privacyPolicy: {
