export const en = {
    ...
    onboarding: {
        title: "Ask a free model right away",
        description: "No setup or sign-in is needed for your first question.",
        compareTitle: "Type your question",
        compareBody: "Start with one free model as a guest.",
        filesTitle: "Review the answer",
        filesBody: "Get a response and continue from the input.",
        privateTitle: "Sign in for the full workspace",
        privateBody: "Unlock up to 3-model comparison, files, Private Mode, and sharing.",
