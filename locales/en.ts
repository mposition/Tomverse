export const en = {
    ...
    chat: {
        ...
        toolsAssistantCreate: "Create a profile",
        toolsAssistantCreateDescription: "A name and instructions are all it takes",
        toolsAssistantManage: "Manage profiles",
    ...
    settingsNav: {
        ...
        profilesAndMemory: "Profiles and memory",
        profilesAndMemoryDescription: "Manage your AI profiles and the account's long-term memory.",
    },
    ...
    assistantProfiles: {
        pageTitle: "My AI profiles",
        backToList: "Back to AI profiles",
        backToChat: "Back to the chat",
        pageDescription: "A profile is your own set of instructions, a model and knowledge files. It is private to your account: profiles are never shared, listed or sold.",
        loading: "Loading your profiles…",
        disabled: "AI profiles are not available on this account yet.",
        loadFailed: "Your profiles could not be loaded. Retry in a moment.",
        countSummary: "{count} of {max} profiles",
        atCapacity: "You have reached the profile limit. Delete one to add another.",
        create: "New profile",
        createAction: "Create profile",
        empty: "You have no profiles yet. Create one to give an assistant your own instructions.",
        ...
        newTitle: "New AI profile",
        editTitle: "Edit AI profile",
        identityHeading: "Name and description",
        identityHint: "Renaming a profile does not change how it answers, so it saves on its own.",
        nameLabel: "Name",
        ...
        toolsNarrowOnly: "A profile can switch a tool off. It cannot add one your plan does not include.",
        memoryLabel: "Use approved account memory",
        memoryNarrowOnly: "A profile can switch memory off for itself. It cannot turn it on when your account has memory off.",
        ...
        deleteHeading: "Delete this profile",
        ...
        noticeSaved: "Saved.",
        noticePublished: "Profile updated.",
        noticeUnchanged: "Nothing changed, so no revision was created.",
        noticeStale: "This profile changed in another tab. Reload before publishing again.",
    ...
    privacyPolicy: {
        ...
        assistantProfiles: "If you create an AI profile, Tomverse stores the name, description, instructions, model choice and conversation starters you enter, and keeps every published revision so a conversation can show what it actually ran under. Knowledge files you attach are stored privately for your account; Tomverse extracts their text, splits it into passages and builds a search index over them so relevant excerpts can be found. When you chat with a profile, its instructions and the excerpts that match your message are sent as reference material to the AI provider that generates the answer. Excerpts are treated as reference material and never as instructions to the assistant. Profiles are private: they are not shared with other people, not listed publicly and not sold. Deleting a profile removes its revisions and its knowledge files, and the stored files are erased shortly afterwards; conversations that used the profile stay readable in your account. Turning a profile off, or deleting it, stops it being used in new chats.",
