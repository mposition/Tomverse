export const en = {
    ...
    chat: {
        ...
        duplicateAttachmentObject: "The same file is attached more than once. Remove the duplicate and send again.",
        conversationAttachmentLimit: "This conversation has reached its file limit. Start a new chat to attach more.",
        guestConversationAttachmentLimit: "This guest chat has reached its file limit. Sign in to keep attaching files.",
