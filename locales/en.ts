export const en = {
    ...
    assistantPackageImport: {
        ...
        problemModelIds: "Choose at least one model, and no more than an assistant allows.",
    ...
    assistantProfiles: {
        ...
        modelsLabel: "Models",
        modelsHint: "Uses your new-conversation default when nothing is selected. Up to three; the first is the default.",
