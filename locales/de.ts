...
export const de = {
    sidebar: {
        ...
        deleteProject: "Projekt l?schen",
        projectRenameFailed: "Projektname konnte nicht aktualisiert werden.",
        projectDeleteConfirm: "Noch einmal klicken, um dieses Projekt zu l?schen. Chats werden nach Nicht klassifiziert verschoben.",
        projectDeleteFailed: "Projekt konnte nicht gel?scht werden.",
    },
    chat: {
        ...
        guestLimitReachedBody: "Melden Sie sich an, um gespeicherte Chats, Teilen, Downloads und Anh?nge weiter zu nutzen.",
        accountLimitReachedTitle: "Planlimit erreicht",
        dailyLimitReachedBody: "Ihr t?gliches Nachrichtenlimit ist aufgebraucht. Fahren Sie nach dem n?chsten Reset fort oder beantragen Sie ein Upgrade.",
        monthlyLimitReachedBody: "Ihr monatliches Nachrichtenlimit ist aufgebraucht. Fahren Sie nach dem n?chsten Reset fort oder beantragen Sie ein Upgrade.",
    ...
    share: {
        ...
        publicDocumentDescription: "Ein ?ffentlicher schreibgesch?tzter Snapshot aus Tomverse. Sp?tere Chat-Updates werden dieser Seite nicht hinzugef?gt.",
        readOnly: "Nur Lesen",
    ...
    billing: {
        ...
        promoProDescription: "Pro kostet 19 $/Monat. Gib TOMVERSE50 ein und spare in den ersten 3 Monaten 50 %.",
        promoMaxDescription: "Max kostet 35 $/Monat. Gib TOMVERSE50 ein und spare in den ersten 3 Monaten 50 %.",
    ...
    auth: {
        ...
        attachmentRetentionNotice: "Tempor?r hochgeladene Dateien werden f?r Modellbereitstellung und Extraktion genutzt und nach etwa einem Tag gel?scht.",
        ...
        planPolicyPro: "Pro: alle Modellstufen mit höheren Nutzungslimits. Regulärer Preis: 19 $/Monat.",
        planPolicyMax: "Max: alle Modellstufen ohne tägliches Nachrichtenlimit, plus monatlicher Fair-Use- und Provider-Kostenschutz. Regulärer Preis: 35 $/Monat.",
    },
    privacyPolicy: {
