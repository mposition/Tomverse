...
const MANIFEST = [
  ...
  { file: "attachment-flow.spec.ts", title: "image attachments disable text-only models and keep vision models selectable", categories: ["attachmentModelCompat"], mandatory: true },
