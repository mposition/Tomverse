-- Image-request handoff chip analytics events.
--
-- docs/policy/image-generation.md §13.
--
...
--
-- Adds the three events that measure the composer's image-request suggestion:
-- how often it was offered, how often it was right, and how often it was in
-- the way. Its two properties are closed enums -- the class the shared
-- classifier returned and whether the viewer was locked -- so the draft the
-- verdict came from has no key to travel in.
--
