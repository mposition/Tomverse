-- Deep Research expansion offer analytics events.
--
-- lib/deepResearchSuggestion.ts. The offer appears under a finished answer
-- when several compared sources would add something, and the questions
-- aggregate data can answer about it are how often it was made, how often it
-- was taken and how often it was waved away -- so there are three events and
-- no fourth.
--
