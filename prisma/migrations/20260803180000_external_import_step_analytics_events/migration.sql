-- External import wizard step analytics events (Release A wizard slice).
--
-- docs/policy/external-conversation-import-and-memory.md §22.
--
...
--
-- Adds external_import_step_entered / external_import_step_abandoned. Both
-- carry only the closed `import_step` enum -- no filename, title, body,
-- external id, fingerprint or digest.
