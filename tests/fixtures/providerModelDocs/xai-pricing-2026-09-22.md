...
Grok 4.7 Fast is the same Grok 4.7 model served on faster infrastructure, at twice the standard token rates. It is available only through [Cursor](https://cursor.com) and [Grok Build](/build/overview); it is not available on the public xAI API, and Grok Build's free tier does not include it.
