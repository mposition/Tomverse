  ...
  return (
    <section className="rounded-3xl border border-zinc-800 bg-zinc-950/70 p-5">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <span className="inline-flex items-center gap-2 rounded-full border border-zinc-700 bg-zinc-900 px-3 py-1 text-xs font-bold text-zinc-300">
      ...
      <div className="mt-5 grid gap-2 md:grid-cols-2 xl:grid-cols-4">
        {views.map((view) => (
          ...
          >
            <Link
              href={view.href}
              className="block cursor-pointer text-sm font-bold text-white hover:text-blue-200"
            >
              {view.label}
            </Link>
            <button
              ...
              className="mt-3 inline-flex cursor-pointer items-center gap-1 rounded-lg border border-zinc-700 px-2 py-1 text-xs font-bold text-zinc-300 transition hover:bg-zinc-800"
            >
