    ...
    return (
        <div ref={containerRef} className="group/account relative inline-flex">
            <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-teal-600 text-sm font-bold text-white ring-1 ring-teal-400/50 transition hover:ring-2 hover:ring-teal-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 dark:bg-teal-700 dark:ring-teal-400/40"
            >
                {user ? (
                    user.image ? (
                    ...
                    {user ? (
                        <>
                            <div className="flex min-w-0 items-center gap-2 border-b border-zinc-200 p-2 pb-3 dark:border-zinc-800">
                                <span className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-teal-600 text-sm font-bold text-white">
                                    {user.image ? (
                                        // eslint-disable-next-line @next/next/no-img-element
                                        <img src={user.image} alt="" className="h-full w-full object-cover" />
                                    ) : (
