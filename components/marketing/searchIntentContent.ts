...
> = {
  "compare-ai-models": {
    en: withCta("en", {
      metadataTitle: "Compare AI Models Side by Side",
      metadataDescription:
        "Compare answers from leading AI models side by side with the same prompt, follow-up questions, and optional file context in Tomverse AI.",
      eyebrow: "AI model comparison",
      title: "Compare AI models side by side",
      description:
        "The most useful model depends on the task, prompt, available context, and current model version. Tomverse lets you send one question to multiple selected models and evaluate their answers in one workspace.",
      sections: [
        {
    ...
    ko: withCta("ko", {
      metadataTitle: "AI 모델 답변을 나란히 비교하기",
      metadataDescription:
        "Tomverse AI에서 같은 질문과 파일 맥락을 여러 주요 AI 모델에 보내고 답변과 후속 질문을 한 화면에서 비교하세요.",
      eyebrow: "AI 모델 비교",
      title: "여러 AI 모델을 나란히 비교하세요",
      description:
        "가장 유용한 모델은 작업, 질문 방식, 제공한 맥락과 현재 모델 버전에 따라 달라집니다. Tomverse에서는 하나의 질문을 선택한 여러 모델에 보내고 한 워크스페이스에서 답변을 검토할 수 있습니다.",
      sections: [
    ...
    zh: withCta("zh", {
      metadataTitle: "并排比较多个 AI 模型",
      metadataDescription: "在 Tomverse AI 中向多个主流 AI 模型发送相同问题和文件上下文，并在一个界面比较回答与追问。",
      eyebrow: "AI 模型比较",
      title: "并排比较多个 AI 模型",
      description: "最合适的模型取决于任务、提示词、上下文和当前版本。Tomverse 可将同一个问题发送给多个所选模型，并在一个工作区中评估结果。",
      sections: [
    ...
    fr: withCta("fr", {
      metadataTitle: "Comparer plusieurs modèles d’IA côte à côte",
      metadataDescription: "Envoyez la même demande et le même contexte à plusieurs modèles d’IA, puis comparez leurs réponses et questions de suivi dans Tomverse AI.",
      eyebrow: "Comparaison de modèles d’IA",
      title: "Comparez les modèles d’IA côte à côte",
      description: "Le modèle le plus utile dépend de la tâche, du prompt, du contexte et de sa version actuelle. Tomverse envoie une même question aux modèles sélectionnés et rassemble les résultats.",
      sections: [
    ...
    de: withCta("de", {
      metadataTitle: "KI-Modelle direkt nebeneinander vergleichen",
      metadataDescription: "Senden Sie dieselbe Frage und denselben Dateikontext an mehrere KI-Modelle und vergleichen Sie Antworten und Folgefragen in Tomverse AI.",
      eyebrow: "KI-Modellvergleich",
      title: "KI-Modelle nebeneinander vergleichen",
      description: "Welches Modell am besten passt, hängt von Aufgabe, Prompt, Kontext und aktueller Version ab. Tomverse sendet eine Frage an ausgewählte Modelle und bündelt die Ergebnisse.",
      sections: [
    ...
    es: withCta("es", {
      metadataTitle: "Comparar modelos de IA en paralelo",
      metadataDescription: "Envía la misma pregunta y contexto de archivo a varios modelos de IA y compara sus respuestas y seguimientos en Tomverse AI.",
      eyebrow: "Comparación de modelos de IA",
      title: "Compara modelos de IA en paralelo",
      description: "El modelo más útil depende de la tarea, el prompt, el contexto y la versión actual. Tomverse envía una pregunta a los modelos seleccionados y reúne sus resultados.",
      sections: [
    ...
    pt: withCta("pt", {
      metadataTitle: "Comparar modelos de IA lado a lado",
      metadataDescription: "Envie a mesma pergunta e contexto de arquivo para vários modelos de IA e compare respostas e acompanhamentos no Tomverse AI.",
      eyebrow: "Comparação de modelos de IA",
      title: "Compare modelos de IA lado a lado",
      description: "O modelo mais útil depende da tarefa, do prompt, do contexto e da versão atual. O Tomverse envia uma pergunta aos modelos selecionados e reúne os resultados.",
      sections: [
