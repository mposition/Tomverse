...
const copy: { en: LandingCopy } & Partial<Record<Language, LandingCopy>> = {
  en: {
    ...
    pricingPlans: [
      { title: "Free", price: "$0", description: "For trying Tomverse and light daily work.", bullets: ["300 monthly · 30 daily AI response credits", "30 Pro-model responses per month", "Files, sharing, and downloads after login"] },
      { title: "Pro", price: "$15/mo", description: "For everyday multi-model comparison.", bullets: ["3,000 monthly · 150 daily credits", "All available models with weighted usage", "Files, sharing, downloads"] },
      { title: "Max", price: "$25/mo", description: "For heavier AI workflows.", bullets: ["8,000 monthly credits", "No daily credit guardrail", "Fair-use and provider cost protection"] },
    ],
  ...
  ko: {
    ...
    pricingPlans: [
      { title: "Free", price: "$0", description: "Tomverse를 체험하고 가벼운 일상 작업을 하기 위한 플랜입니다.", bullets: ["월 300 · 일 30 AI 응답 크레딧", "Pro 모델 월 30응답", "로그인 후 파일, 공유, 다운로드"] },
      { title: "Pro", price: "$15/월", description: "매일 여러 모델을 비교하는 사용자에게 적합합니다.", bullets: ["월 3,000 · 일 150 크레딧", "모든 모델 및 가중 차감", "파일, 공유, 다운로드"] },
      { title: "Max", price: "$25/월", description: "더 많은 AI 작업을 수행하는 사용자에게 적합합니다.", bullets: ["월 8,000 크레딧", "일일 크레딧 가드레일 없음", "공정사용 및 공급자 비용 보호"] },
    ],
    faqTitle: "자주 묻는 질문",
    faqs: [
  ...
  zh: {
    ...
    pricingPlans: [
      ...
      { title: "Max", price: "$25/月", description: "适合更高强度的 AI 工作流。", bullets: ["每月 8,000 积分", "无每日积分限制", "fair-use 和提供商成本保护"] },
    ],
    faqTitle: "常见问题",
    faqs: [
  ...
  fr: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Pour essayer Tomverse et un travail quotidien léger.", bullets: ["300 crédits/mois · 30/jour", "30 réponses Pro par mois", "Fichiers, partage et téléchargements"] }, { title: "Pro", price: "$15/mois", description: "Pour la comparaison multi-modèles quotidienne.", bullets: ["3 000 crédits/mois · 150/jour", "Tous les modèles avec usage pondéré", "Fichiers, partage, téléchargements"] }, { title: "Max", price: "$25/mois", description: "Pour les workflows IA plus intensifs.", bullets: ["8 000 crédits/mois", "Sans garde-fou quotidien", "Fair-use et protection des coûts"] }],
  ...
  de: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Zum Ausprobieren von Tomverse und für leichte tägliche Arbeit.", bullets: ["300 Credits/Monat · 30/Tag", "30 Pro-Antworten pro Monat", "Dateien, Teilen und Downloads"] }, { title: "Pro", price: "$15/Monat", description: "Für täglichen Multi-Modell-Vergleich.", bullets: ["3.000 Credits/Monat · 150/Tag", "Alle Modelle mit gewichteter Nutzung", "Dateien, Teilen, Downloads"] }, { title: "Max", price: "$25/Monat", description: "Für intensivere KI-Workflows.", bullets: ["8.000 Credits/Monat", "Kein täglicher Credit-Grenzwert", "Fair-Use und Kostenschutz"] }],
  ...
  es: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Para probar Tomverse y trabajo diario ligero.", bullets: ["300 créditos/mes · 30/día", "30 respuestas Pro al mes", "Archivos, compartir y descargas"] }, { title: "Pro", price: "$15/mes", description: "Para comparación multimodelo diaria.", bullets: ["3.000 créditos/mes · 150/día", "Todos los modelos con uso ponderado", "Archivos, compartir, descargas"] }, { title: "Max", price: "$25/mes", description: "Para flujos de IA más intensivos.", bullets: ["8.000 créditos/mes", "Sin límite diario de créditos", "Fair-use y protección de costes"] }],
  ...
  pt: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Para testar o Tomverse e trabalhos diários leves.", bullets: ["300 créditos/mês · 30/dia", "30 respostas Pro por mês", "Arquivos, compartilhamento e downloads"] }, { title: "Pro", price: "$15/mês", description: "Para comparação multimodelo diária.", bullets: ["3.000 créditos/mês · 150/dia", "Todos os modelos com uso ponderado", "Arquivos, compartilhamento, downloads"] }, { title: "Max", price: "$25/mês", description: "Para fluxos de IA mais intensivos.", bullets: ["8.000 créditos/mês", "Sem limite diário de créditos", "Fair-use e proteção de custos"] }],
