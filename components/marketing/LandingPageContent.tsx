...
const copy: { en: LandingCopy } & Partial<Record<Language, LandingCopy>> = {
  en: {
    ...
    pricingPlans: [
      { title: "Free", price: "$0", description: "300 monthly AI credits for light everyday use and trying advanced models.", bullets: ["300 monthly AI credits", "30 Pro-model responses per month", "Files, sharing, and downloads after login"] },
  ...
  ko: {
    ...
    pricingPlans: [
      { title: "Free", price: "$0", description: "가벼운 일상 사용과 고급 모델 체험을 위한 월 300 AI 크레딧", bullets: ["월 300 AI 크레딧", "Pro 모델 월 30응답", "로그인 후 파일, 공유, 다운로드"] },
