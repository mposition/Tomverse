...
const copy: { en: LandingCopy } & Partial<Record<Language, LandingCopy>> = {
  ...
  fr: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Pour essayer Tomverse et un travail quotidien léger.", bullets: ["Niveaux de modèles Free et Pro", "Usage quotidien avec limite", "Fichiers, partage et téléchargements après connexion"] }, { title: "Pro", price: "$15/mois", description: "Pour la comparaison multi-modèles quotidienne.", bullets: ["TOMVERSE50 : 50 % de réduction pendant 3 mois", "Tous les modèles disponibles", "Fichiers, partage, téléchargements"] }, { title: "Max", price: "$25/mois", description: "Pour les workflows IA plus intensifs.", bullets: ["TOMVERSE50 : 50 % de réduction pendant 3 mois", "Aucune limite quotidienne de messages", "Protection mensuelle fair-use"] }],
  ...
  de: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Zum Ausprobieren von Tomverse und für leichte tägliche Arbeit.", bullets: ["Free- und Pro-Modellstufen", "Tägliche Arbeit mit Nutzungslimit", "Dateien, Teilen und Downloads nach Anmeldung"] }, { title: "Pro", price: "$15/Monat", description: "Für täglichen Multi-Modell-Vergleich.", bullets: ["TOMVERSE50: 50 % Rabatt für 3 Monate", "Alle verfügbaren Modelle", "Dateien, Teilen, Downloads"] }, { title: "Max", price: "$25/Monat", description: "Für intensivere KI-Workflows.", bullets: ["TOMVERSE50: 50 % Rabatt für 3 Monate", "Kein tägliches Nachrichtenlimit", "Monatlicher Fair-Use-Schutz"] }],
