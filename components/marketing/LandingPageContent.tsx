...
const copy: { en: LandingCopy } & Partial<Record<Language, LandingCopy>> = {
  en: {
    ...
    pricingPlans: [
      ...
      { title: "Pro", price: "$15/mo", description: "For everyday multi-model comparison.", bullets: ["Launch special: 50% off for 3 months", "All available models", "Files, sharing, downloads"] },
      { title: "Max", price: "$25/mo", description: "For heavier AI workflows.", bullets: ["Launch special: 50% off for 3 months", "No daily message limit", "Monthly fair-use protection"] },
    ],
  ...
  ko: {
    ...
    pricingPlans: [
      ...
      { title: "Pro", price: "$15/월", description: "매일 여러 모델을 비교하는 사용자에게 적합합니다.", bullets: ["?? ?? 3?? 50% ??", "모든 사용 가능 모델", "파일, 공유, 다운로드"] },
      { title: "Max", price: "$25/월", description: "더 많은 AI 작업을 수행하는 사용자에게 적합합니다.", bullets: ["?? ?? 3?? 50% ??", "일일 메시지 무제한", "월간 fair-use 보호"] },
    ],
    faqTitle: "자주 묻는 질문",
    faqs: [
  ...
  zh: {
    ...
    pricingPlans: [
      ...
      { title: "Pro", price: "$15/月", description: "适合每天进行多模型比较的用户。", bullets: ["?????? 3 ?? 50% ??", "所有可用模型", "文件、分享、下载"] },
      { title: "Max", price: "$25/月", description: "适合更高强度的 AI 工作流。", bullets: ["?????? 3 ?? 50% ??", "每日消息无限制", "月度 fair-use 保护"] },
    ],
    faqTitle: "常见问题",
    faqs: [
  ...
  fr: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Pour essayer Tomverse et un travail quotidien léger.", bullets: ["Niveaux de modèles Free et Pro", "Usage quotidien avec limite", "Fichiers, partage et téléchargements après connexion"] }, { title: "Pro", price: "$15/mois", description: "Pour la comparaison multi-modèles quotidienne.", bullets: ["Offre de lancement : -50 % pendant 3 mois", "Tous les modèles disponibles", "Fichiers, partage, téléchargements"] }, { title: "Max", price: "$25/mois", description: "Pour les workflows IA plus intensifs.", bullets: ["Offre de lancement : -50 % pendant 3 mois", "Aucune limite quotidienne de messages", "Protection mensuelle fair-use"] }],
  ...
  de: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Zum Ausprobieren von Tomverse und für leichte tägliche Arbeit.", bullets: ["Free- und Pro-Modellstufen", "Tägliche Arbeit mit Nutzungslimit", "Dateien, Teilen und Downloads nach Anmeldung"] }, { title: "Pro", price: "$15/Monat", description: "Für täglichen Multi-Modell-Vergleich.", bullets: ["Launch-Angebot: 50 % Rabatt f?r 3 Monate", "Alle verfügbaren Modelle", "Dateien, Teilen, Downloads"] }, { title: "Max", price: "$25/Monat", description: "Für intensivere KI-Workflows.", bullets: ["Launch-Angebot: 50 % Rabatt f?r 3 Monate", "Kein tägliches Nachrichtenlimit", "Monatlicher Fair-Use-Schutz"] }],
  ...
  pt: {
    ...
    pricingPlans: [{ title: "Free", price: "$0", description: "Para testar o Tomverse e trabalhos diários leves.", bullets: ["Níveis de modelos Free e Pro", "Trabalho diário com limite de uso", "Arquivos, compartilhamento e downloads após login"] }, { title: "Pro", price: "$15/mês", description: "Para comparação multimodelo diária.", bullets: ["Oferta de lan?amento: 50% de desconto por 3 meses", "Todos os modelos disponíveis", "Arquivos, compartilhamento, downloads"] }, { title: "Max", price: "$25/mês", description: "Para fluxos de IA mais intensivos.", bullets: ["Oferta de lan?amento: 50% de desconto por 3 meses", "Sem limite diário de mensagens", "Proteção mensal fair-use"] }],
