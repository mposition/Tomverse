...
const copy = {
  en: {
    ...
    table: {
      ...
      max: "Max",
      rows: [
        { label: "Model access", free: "Free models", pro: "All models with Pro usage limits", max: "All models with the largest allowance" },
        { label: "Multi-model comparison", free: "1 model", pro: "Up to 3 models", max: "Up to 3 models" },
        { label: "File attachments", free: "Basic images", pro: "Images, PDFs, Office, Drive", max: "Higher file and context limits" },
        { label: "Conversation sharing", free: "-", pro: "Share and download", max: "Share, download, priority limits" },
        { label: "Usage allowance", free: "Basic daily usage", pro: "Higher daily and monthly usage", max: "Largest usage allowance" },
      ],
    },
    ...
    faqs: [
      {
        ...
        answer: "Yes. The Free plan is intended for light daily use and access to selected free models.",
      },
      {
    ...
    plans: [
      {
        ...
        features: [
          "Access to Free model tier",
          "Single-model chat workspace",
          "Basic chat history",
          "Guest and login modes",
  ...
  ko: {
    ...
    table: {
      ...
      rows: [
        ...
        { label: "사용량", free: "기본 일일 사용량", pro: "더 높은 일일/월간 사용량", max: "가장 큰 사용량 한도" },
      ],
    },
    faqTitle: "요금 관련 질문",
    faqs: [
