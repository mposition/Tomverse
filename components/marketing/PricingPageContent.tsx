...
const copy: { en: PricingCopy } & Partial<Record<Language, PricingCopy>> = {
  ...
  ko: {
    ...
    plans: [
      ...
      { name: "Pro", eyebrow: "일상 생산성", price: "$15", period: "월", description: "모델을 비교하고, 파일을 첨부하고, 대화를 주중 업무에 재사용하는 사용자에게 적합합니다.", cta: "Pro로 업그레이드", href: "/chat", highlighted: true, badge: "추천", usage: "출시 특가: 첫 달 $7.50", features: ["모든 사용 가능 모델 등급 접근", "최대 3개 모델 나란히 비교", "파일 첨부 및 Google Drive 파일", "대화 공유 및 다운로드", "더 높은 일일 및 월간 한도"] },
      { name: "Max", eyebrow: "고강도 AI 워크플로", price: "$25", period: "월", description: "프리미엄 모델 등급, 더 큰 사용량, 우선 사용 여유가 필요한 파워 유저를 위한 플랜입니다.", cta: "Max로 업그레이드", href: "/chat", usage: "출시 특가: 첫 달 $12.50", features: ["Free, Pro, Max 모델 등급 접근", "일일 메시지 무제한 및 월간 fair-use 보호", "더 높은 첨부파일 및 맥락 한도", "고급 모델 등급 우선 접근", "고강도 일상 AI 작업에 적합"] },
    ],
  },
  zh: {
    eyebrow: "价格",
    ...
    plans: [
      ...
      { name: "Max", eyebrow: "高强度 AI 工作流", price: "$25", period: "每月", description: "适合需要高级模型、更大额度和优先使用空间的高频用户。", cta: "升级到 Max", href: "/chat", usage: "发布特价：首月 $12.50", features: ["访问 Free、Pro 和 Max 模型等级", "每日消息无限制，并有月度 fair-use 保护", "更高的附件和上下文限制", "优先访问高级模型等级", "为高强度日常 AI 工作流设计"] },
    ],
  },
  fr: {
    eyebrow: "Tarifs",
    ...
    plans: [
      ...
      { name: "Max", eyebrow: "Workflows IA intensifs", price: "$25", period: "par mois", description: "Pour les utilisateurs intensifs qui ont besoin de modèles avancés, de volumes plus importants et d'une marge prioritaire.", cta: "Passer à Max", href: "/chat", usage: "Offre de lancement : 12,50 $ le premier mois", features: ["Accès aux niveaux Free, Pro et Max", "Aucune limite quotidienne de messages avec protection mensuelle fair-use", "Limites de pièces jointes et de contexte plus élevées", "Accès prioritaire aux modèles avancés", "Conçu pour les workflows IA quotidiens intensifs"] },
    ],
  },
  de: {
    eyebrow: "Preise",
