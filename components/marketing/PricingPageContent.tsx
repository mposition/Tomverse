...
const copy: { en: PricingCopy } & Partial<Record<Language, PricingCopy>> = {
  ...
  ko: {
    ...
    billingNote: "출시 혜택: TOMVERSE50 코드로 Pro 또는 Max 첫 3개월 50% 할인. 언제든 취소할 수 있습니다.",
    ...
    faqs: [
      ...
      { question: "출시 할인은 어떻게 적용되나요", answer: "결제 시 TOMVERSE50 코드를 입력하면 Pro 또는 Max 첫 3개월 동안 50% 할인을 받을 수 있습니다. 이후에는 취소하지 않는 한 정가 월 요금으로 갱신됩니다." },
  ...
  zh: {
    ...
    billingNote: "发布优惠：使用 TOMVERSE50，Pro 或 Max 前 3 个月享 50% 折扣。可随时取消。",
    ...
    faqs: [
      ...
      { question: "发布折扣如何使用？", answer: "结账时输入 TOMVERSE50，即可在 Pro 或 Max 前 3 个月享受 50% 折扣。之后除非取消，否则会按标准月费续订。" },
  ...
  fr: {
    ...
    billingNote: "Offre de lancement : utilisez le code TOMVERSE50 pour obtenir 50 % de réduction sur Pro ou Max pendant vos 3 premiers mois. Annulation possible à tout moment.",
    ...
    faqs: [
      ...
      { question: "Comment fonctionne la réduction de lancement ?", answer: "Saisissez le code TOMVERSE50 au paiement pour obtenir 50 % de réduction sur Pro ou Max pendant les 3 premiers mois. Ensuite, le plan se renouvelle au prix mensuel standard, sauf annulation." },
    ...
    plans: [
      ...
      { name: "Pro", eyebrow: "Productivité quotidienne", price: "$15", period: "par mois", description: "Pour les personnes qui comparent des modèles, joignent des fichiers et réutilisent leurs conversations chaque semaine.", cta: "Passer à Pro", href: "/chat", highlighted: true, badge: "Recommandé", usage: "Promo TOMVERSE50 : 7,50 $/mois pendant 3 mois", features: ["Accès à tous les niveaux de modèles disponibles", "Comparer jusqu'à 3 modèles côte à côte", "Pièces jointes et fichiers Google Drive", "Partager et télécharger les conversations", "Limites quotidiennes et mensuelles plus élevées"] },
      { name: "Max", eyebrow: "Workflows IA intensifs", price: "$25", period: "par mois", description: "Pour les utilisateurs intensifs qui ont besoin de modèles avancés, de volumes plus importants et d'une marge prioritaire.", cta: "Passer à Max", href: "/chat", usage: "Promo TOMVERSE50 : 12,50 $/mois pendant 3 mois", features: ["Accès aux niveaux Free, Pro et Max", "Aucune limite quotidienne de messages avec protection mensuelle fair-use", "Limites de pièces jointes et de contexte plus élevées", "Accès prioritaire aux modèles avancés", "Conçu pour les workflows IA quotidiens intensifs"] },
    ],
  },
  de: {
    eyebrow: "Preise",
    ...
    billingNote: "Launch-Angebot: Mit TOMVERSE50 erhalten Sie in den ersten 3 Monaten 50 % Rabatt auf Pro oder Max. Jederzeit kündbar.",
    ...
    faqs: [
      ...
      { question: "Wie funktioniert der Launch-Rabatt?", answer: "Geben Sie beim Checkout TOMVERSE50 ein, um in den ersten 3 Monaten 50 % Rabatt auf Pro oder Max zu erhalten. Danach verlängert sich der Plan zum regulären Monatspreis, sofern er nicht gekündigt wird." },
  ...
  es: {
    ...
    faqs: [
      ...
      { question: "¿Cómo funciona el descuento de lanzamiento?", answer: "Introduce TOMVERSE50 al pagar para recibir 50 % de descuento en Pro o Max durante los primeros 3 meses. Después, el plan se renueva al precio mensual regular salvo cancelación." },
    ...
    plans: [
      ...
      { name: "Max", eyebrow: "Flujos intensivos de IA", price: "$25", period: "al mes", description: "Para usuarios avanzados que necesitan modelos premium, mayores asignaciones y margen prioritario.", cta: "Actualizar a Max", href: "/chat", usage: "Promo TOMVERSE50: $12.50/mes durante 3 meses", features: ["Acceso a niveles Free, Pro y Max", "Sin límite diario de mensajes con protección mensual fair-use", "Límites superiores de adjuntos y contexto", "Acceso prioritario a modelos avanzados", "Diseñado para flujos diarios intensivos de IA"] },
    ],
  },
  pt: {
    eyebrow: "Preços",
    ...
    billingNote: "Oferta de lançamento: use TOMVERSE50 para obter 50% de desconto no Pro ou Max nos 3 primeiros meses. Cancele quando quiser.",
    ...
    faqs: [
      ...
      { question: "Como funciona o desconto de lançamento?", answer: "Digite TOMVERSE50 no checkout para receber 50% de desconto no Pro ou Max nos 3 primeiros meses. Depois disso, o plano renova pelo preço mensal regular, salvo cancelamento." },
    ...
    plans: [
      ...
      { name: "Pro", eyebrow: "Produtividade diária", price: "$15", period: "por mês", description: "Para pessoas que comparam modelos, anexam arquivos e reutilizam conversas durante a semana.", cta: "Atualizar para Pro", href: "/chat", highlighted: true, badge: "Recomendado", usage: "Promo TOMVERSE50: US$7.50/mês por 3 meses", features: ["Acesso a todos os níveis de modelos disponíveis", "Comparar até 3 modelos lado a lado", "Anexos e arquivos do Google Drive", "Compartilhar e baixar conversas", "Limites diários e mensais maiores"] },
      { name: "Max", eyebrow: "Fluxos intensivos de IA", price: "$25", period: "por mês", description: "Para usuários avançados que precisam de modelos premium, franquias maiores e prioridade de uso.", cta: "Atualizar para Max", href: "/chat", usage: "Promo TOMVERSE50: US$12.50/mês por 3 meses", features: ["Acesso aos níveis Free, Pro e Max", "Sem limite diário de mensagens com proteção mensal fair-use", "Limites maiores de anexos e contexto", "Acesso prioritário a modelos avançados", "Feito para fluxos diários intensivos de IA"] },
    ],
  },
};
