...
| symlink/path traversal 또는 거대 파일 | import-closure로 검증되는 180개 고정 path allowlist, fd open/fstat, symlink component 거부, bounded read/post-fstat, 파일당 8 MiB 및 전체 16 MiB cap |
