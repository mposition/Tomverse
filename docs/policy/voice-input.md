...
| B-3 | provider 원가 검증 계층 (§6.1-3) | **해결 (2026-09-02)** — audio register + `measured_clip` 승인 |
| B-4 | audio provider 예산 (§6.1-4) | **해결 (2026-09-02)** — 초 단위 일·월 예산, production 필수 |
...
제품·finance 결정으로 함께 닫혔습니다(§6.1). B-5는 별개이고 법무 성격입니다.
B-6은 사람만 할 수 있습니다.
