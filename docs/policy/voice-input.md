...
| B-3 | provider 원가 검증 계층 (§6.1-3) | **해결 (2026-09-08)** — 기본 모델의 실제 청구 관측·대조 완료(§6.1.3, #1247). `gpt-4o-transcribe`는 미검증 보류이며 기본 모델이 아닙니다 |
...
| B-5 | provider 데이터 보존 (§11.3) | **차단** — 계정 설정·DPA·ZDR 확인 대기 |
...
남아 있었으며(2026-09-08에 관측돼 닫혔습니다, §6.1.3), B-4는 코드가 서 있고 각
