...
확인됐다"**로. 남은 넷은 저장소가 답할 수 없습니다: ZDR 자격·승인(영업),
DPA 편입과 처리 지역(법무), ZDR을 production 필수조건으로 둘지(정책),
그리고 §11.3.2-1의 `None` 대 30일(공급자).
...
| B-5 | provider 데이터 보존 (§11.3) | **차단** — 계정 관측 완료(2026-09-10, §11.3.2), 외부 승인·정책 결정 대기: ZDR 자격·승인, DPA·처리 지역, ZDR을 필수조건으로 둘지 |
...
(`docs/ops/voice-provider-data-controls-records/2026-09-10-account-observation.md`).
그 뒤로는 영업·법무·정책 결정이며, 어느 것도 이 저장소에서 관측되지 않습니다.
