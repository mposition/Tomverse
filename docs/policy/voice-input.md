...
| B-5 | provider 데이터 보존 (§11.3) | **차단** — 판정과 서명 셋 완료(2026-09-10, §11.3.2). US endpoint 고정은 공급자가 조직을 `incorrect_hostname` 401로 거절해 **철회**됐고 Global로 복귀했습니다(§11.3.0 정정). 그에 따라 고지 2번 항목의 근거가 바뀌어 **2026-09-10의 문구 승인은 현재 판본을 덮지 않습니다**(§11.4). 남은 것: 새 문구의 **법률 승인**, 수령 법인 **소재 국가의 계약 원문 대조**, 실제 요청 관측, 최종 판정·서명 |
