...
| B-5 | provider 데이터 보존 (§11.3) | **차단** — 판정과 서명 셋 완료(2026-09-10, §11.3.2), 미국 지역 endpoint 고정(§11.3.0), 국외이전 고지 8항목 구현(§11.4). 남은 것: 고지 문구의 **법률 승인**, staging deploy에서의 **실제 요청 관측**, 사람의 **최종 판정·서명** |
...
**production을 막고 있는 둘 다 사람의 손이 필요하고, 종류가 다릅니다.**
B-5는 공급자와 법무의 답을 기다리고(§11.3.2), B-6은 실기기와 사람의 서명을
기다립니다.
...
들어왔습니다. **남은 것은 국외이전 고지 5개 항목 하나입니다.** 저장소의 문구를
고치는 일이지만 **문구 작성이 아니라 법적 판단**이고, 이전받는 자의 국가는
서명문이 임의 기재를 금지했으며, 거부 방법·절차는 제품에 거부 수단이 있어야
문구가 성립합니다.
