...
2. **개인정보 처리방침** — `privacyPolicy.voiceInput`, 7개 locale 전부. "외부 AI
   ...
   **이 여덟 항목의 문구는 2026-09-10에 승인됐고, 승인된 revision은
   `6019e07afd598a1431862ec925189a04544e9c94`입니다**
   (`docs/ops/voice-provider-data-controls-records/2026-09-10-us-regional-endpoint.md`
   §8-2). 같은 날 이전받는 자 명칭 `OpenAI OpCo, LLC`가 계약 원문과 대조돼
   확인됐습니다(같은 기록 §8-1). **문구를 고치는 변경은 승인을 다시 받습니다** —
   승인은 문장이 아니라 그 SHA에 붙어 있습니다.
...
| B-5 | provider 데이터 보존 (§11.3) | **차단** — 판정과 서명 셋 완료(2026-09-10, §11.3.2), 국외이전 고지 8항목 문구 승인 완료(2026-09-10, §11.4). **staging 관측에서 US endpoint가 조직을 `incorrect_hostname` 401로 거절했고, 그 고정이 있는 한 Voice가 동작하지 않습니다**(§11.3.0 정정). 남은 것: 세 갈래 중 하나에 대한 사람의 결정, 그 뒤의 실제 요청 관측과 최종 판정·서명 |
