...
| B-5 | provider 데이터 보존 (§11.3) | **차단** — 판정과 서명 셋 완료(2026-09-10, §11.3.2), 미국 지역 endpoint 고정 병합(§11.3.0), 국외이전 고지 8항목 **문구 승인 완료**(2026-09-10, §11.4). 남은 것: staging deploy에서의 **실제 요청 관측**과 사람의 **최종 판정·서명** — 둘 다 이 코드가 도는 환경이 있어야 생깁니다 |
...
**production을 막고 있는 둘 다 사람의 손이 필요하고, 종류가 같아졌습니다.**
B-5도 B-6도 이제 **배포된 환경에서의 관측**을 기다립니다 — 법무의 답은
2026-09-10에 왔습니다.
