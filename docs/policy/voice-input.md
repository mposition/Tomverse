...
- production 활성화: **B-1~B-6이 모두 닫혔습니다** (2026-09-10). 남은 것은 flag를 켜는 사람의 결정이며, 그 전에 §14 아래의 열린 항목 — 특히 수령 법인 소재 국가의 계약 원문 대조 — 을 봅니다. §6은 2026-09-02에 결정됐습니다
- 마지막 검토: 2026-09-08
...
| B-5 | provider 데이터 보존 (§11.3) | **해결 (2026-09-10, 통과 서명됨)** — 여섯 조건 모두 충족. deploy `e8613a55…`에서 2026-09-10T11:06:54Z 첫 전사 성공. 서명: Tommy Han, Privacy Owner. **잔여 위험 다섯은 사라진 것이 아니라 수용됐습니다** — 특히 수령 법인 소재 국가는 계약 원문과 **미대조**입니다. 기록: `docs/ops/voice-provider-data-controls-records/2026-09-10-us-regional-endpoint.md` §14 |
...
**통과는 잔여 위험이 없다는 뜻이 아닙니다.** 같은 기록 §14의 7-1~7-5는 수용된
채로 열려 있고, 그중 **수령 법인의 소재 국가가 계약 원문과 대조되지 않았다**는
것만이 사용자에게 보이는 고지 문장에 직접 걸립니다.
