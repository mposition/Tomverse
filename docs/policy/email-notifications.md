...
| C8 | 묵시적 동의를 **국가 rule이 허용하는 곳에서만** 씁니다 — 호주의 추론 동의(4.4 관계 lifecycle). EEA·영국 soft opt-in은 **G(R1 외부 자문)가 닫힐 때까지 쓰지 않습니다** | 아래 5.6 |
...
| **AU** | 4.4의 관계가 서면 `inferred_consent` | 초안 4.4의 여섯 항목 |
...
| **AT** | `express_consent` | ECG-Liste 대조 없이는 해제 없음 |
| **IE** | `express_consent` | 12개월 창·형사범. 이번 범위 밖 |
