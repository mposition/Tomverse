...
**다만 그 사람들에게 확인 메일을 돌려서는 안 됩니다**(2026-09-14 정정,
...
**제품 안에서 다시 받습니다** — 로그인한 사용자에게 설정 화면이나 배너로 확인을
요청하고, 확인 메일은 그 사람이 그 자리에서 요청했을 때만 나갑니다. §5의 흐름이
그대로 쓰이며, 다른 것은 시작점이 사용자의 행동이라는 점뿐입니다.
