...
**52개 항목이 전부 릴리스 차단 사유는 아닙니다.** 그런데 목록만 보면 전부
...
**합계: A 5 + B 6 + C 6 + D-2 1 + E 3 + G-1 1 + H 4 = 26항목, 유료 turn 6~7건.**

### 차단 아님 (켠 뒤에 고쳐도 되는 것)

| 구획 | 왜 아닌가 |
|---|---|
| **D-1·D-3·D-4** | prompt 조립·토큰 계상의 정확성. 틀리면 고쳐서 배포하면 되고, 과금 오류는 환급된다 |
