...
2. **Active·Pending 두 항목 — 모양은 정해졌고, 두 가지가 남았습니다.**
   ...
   **승인은 세 묶음입니다** — **1차 계산 규칙 11건**만 확정되면 규칙이 정해지고 구현에
   착수할 수 있고, **2차 운영 절차 5건**은 그 위에서 돌며(다만 D9는 첫 긴급 교체 전에,
   D6·D6a는 첫 노출 판단 전에 필요합니다), **3차 1건**(다중 계정 세션 폐기)은 fingerprint와
   독립한 문제로 분리했습니다. 승인란은 그 문서 §9.4이고 **사람이 채웁니다.**
