# batch-014 — `durable_facts:en` 검수 시트

> **자동 생성 파일입니다.** `npm run make:memory-eval-review-sheet -- --batch=batch-014`
...
| token | shape | 쌍 |
|---|---|---|
| 0.32 | 0.16 | cand-durable-en-22 ~ cand-durable-en4-37 |
| 0.32 | 0.08 | cand-durable-en-17 ~ cand-durable-en4-29 |
| 0.28 | 0.13 | cand-durable-en-12 ~ cand-durable-en4-20 |
| 0.26 | 0.14 | durable-en-2 ~ cand-durable-en4-39 |
| 0.25 | 0.09 | cand-durable-en4-1 ~ cand-durable-en4-23 |
| 0.25 | 0.00 | cand-durable-en-19 ~ cand-durable-en-20 |
| 0.23 | 0.08 | cand-durable-en-11 ~ cand-durable-en4-18 |
| 0.20 | 0.23 | cand-durable-en4-22 ~ cand-durable-en4-25 |
| 0.23 | 0.08 | cand-durable-en-19 ~ cand-durable-en4-5 |
| 0.22 | 0.15 | cand-durable-en-8 ~ cand-durable-en4-5 |
...
**제안 gold label**: `occupation` — 키워드 `hygienist`
...
**제안 gold label**: `expertise` — 키워드 `calligraphy`
...
**제안 gold label**: `project` — 키워드 `footpaths`
...
**제안 gold label**: `communication_style` — 키워드 `don't know`
...
| 4 | `constraint` | `weekends` | Weekends are completely spoken for. Nothing … |
...
| 11 | `preference` | `subtitles` | I watch everything with subtitles on, even i… |
| 12 | `preference` | `eating alone` | I actually prefer eating alone. Group meals … |
...
| 19 | `expertise` | `engines` | Engines are my trade. You don't need to expl… |
| 20 | `expertise` | `portuguese` + `beginner` | I'm a complete beginner in Portuguese. I don… |
...
| 25 **←표본** | `project` | `footpaths` | I'm mapping the local footpaths, walking and… |
...
| 31 | `relationship` | `mother` + `care home` | My mother is in a care home and I visit twic… |
| 32 | `relationship` | `daughter` + `university` | My daughter is at university, so the house i… |
| 33 **←표본** | `relationship` | `father-in-law` | My father-in-law lives with us, and househol… |
| 34 | `recurring_context` | `appraisal` | Every October is appraisal season and it swa… |
...
| 37 **←표본** | `communication_style` | `don't know` | If you're not sure, say you don't know. A ma… |
| 38 | `communication_style` | `jargon` | Keep the jargon but put a short gloss in bra… |
| 39 | `tone` | `jokes` | No jokes, please. Straight answers only. |
| 40 | `verbosity` | `one paragraph` | One paragraph per answer. I'll ask if I want… |
| 41 | `structure` | `numbered steps` | Anything procedural should come as numbered … |
...
| 45 | `citation_preference` | `publication` | When you cite something, give me the publica… |
