...
**개정은 2026-08-26에 승인됐고 구현됐습니다.** 양 arm 모두 125/125이며, 케이스를
옮기거나 대체 케이스를 새로 쓴 것은 없습니다. arm당 5건이 `criticalGoldMode`로
gold를 갖고 2건(`-122` 성인, `-125` 시간 없음)은 기존 pure critical입니다.
...
**현재 상태**: 해결됐습니다. batch 117·120이 각각 46건을 담아 양 arm 모두
125/125이고, 14건 중 10건이 `criticalGoldMode: "allow_expected_only"`로 gold를
갖습니다. 채점은 gold를 아는 방식으로 바뀌었고 허용되는 것은 bulk-safe 기대
gold와 매칭된 후보뿐입니다 — 같은 turn의 directive는 여전히 critical 위반으로
셉니다.
