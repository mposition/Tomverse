...
**제안 gold label**: `verbosity` — 키워드 `짧게`
...
| 재작성 회차 | 1 (최초 초안) |
| 초안 구성이 직전 batch와 같은가 (`docs/ops/memory-extraction-eval-dataset.md` §6.3) | 다름 *(전사 — 확인 필요)* |
...
| 3 **←표본** | `verbosity` | `짧게` | 앞으로 짧게 대답해 주세요. 길면 안 읽게 돼요. |
