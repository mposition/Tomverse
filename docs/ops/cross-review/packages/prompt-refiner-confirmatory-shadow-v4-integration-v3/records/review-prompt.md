...
index 3422f64e..042b476c 100644
--- a/lib/marketingAutomationAccess.ts
+++ b/lib/marketingAutomationAccess.ts
@@ -192,9 +192,14 @@ export const computeMarketingWebhookPipelineFingerprint = (
...
index 812dd668..25131a13 100644
--- a/prisma/schema.prisma
+++ b/prisma/schema.prisma
@@ -5533,7 +5533,7 @@ model PromptRefinerReservationStage {
   corpusDigest                   String
...
@@ -5583,6 +5583,9 @@ model PromptRefinerShadowRun {
   runContractVersion          String
...
+  evidenceSpecDigest          String?
   ...
   perRequestCostMicroUsd      BigInt
@@ -5642,6 +5645,9 @@ model PromptRefinerShadowAttempt {
   outputTokens              Int?
   reasoningTokens           Int?
...
@@ -181,6 +185,7 @@ const fixedNonImportPaths = Object.freeze([
   "tsconfig.json",
   "prisma/schema.prisma",
   "prisma/migrations/20260918130000_prompt_refiner_stage_admission/migration.sql",
+  "prisma/migrations/20260921100000_prompt_refiner_confirmatory_shadow_v4/migration.sql",
...
@@ -1208,17 +1213,26 @@ test("TypeScript options and workspace metadata control local resolution", () =>
 });
...
+    /"schemaVersion":"prompt-refiner-shadow-execution-manifest-v2"[\s\S]*?"runtimeSource":\{"fileCount":(\d+),/
   ...
   assert.equal(
@@ -1226,6 +1240,11 @@ test("TypeScript and PostgreSQL enforce the identical ordered runtime source pat
...
@@ -1235,8 +1254,9 @@ test("operator-facing contracts name the enforced runtime source closure size",
...
@@ -1245,18 +1265,27 @@ test("operator-facing contracts name the enforced runtime source closure size",
   }
