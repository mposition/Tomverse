 ...
 * `BOARD_PROMOTION_APPLY_CODE_LATCH`. Version 3 ships that constant false.
 ...
 * Version 3 leaves it false. It does not promote a card.
 */
export const BOARD_PROMOTION_APPLY_CODE_LATCH = false;
