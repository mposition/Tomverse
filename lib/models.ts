...
export const AVAILABLE_MODELS = [
    ...
    { id: "llama-3-1", name: "Llama 3.1", apiModel: "llama-3.1-8b-instant", provider: "groq", icon: "∞", bestFor: "Legacy fast, lightweight text questions", minimumPlan: "Guest", usageClass: "standard", replacementModelId: "groq-gpt-oss-120b", publiclyListed: false, enabled: false, status: "disabled", operationalReason: "Tomverse retired Llama 3.1 on 2026-08-01 ahead of Groq's scheduled 2026-08-16 shutdown.", userVisibleNote: "This model was retired and replaced by GPT-OSS 120B on Groq." },
    ...
    { id: "llama-3-3", name: "Llama 3.3", apiModel: "llama-3.3-70b-versatile", provider: "groq", icon: "∞", bestFor: "Legacy open-model text analysis and instruction following", minimumPlan: "Free", usageClass: "advanced", replacementModelId: "groq-gpt-oss-120b", publiclyListed: false, enabled: false, status: "disabled", operationalReason: "Tomverse retired Llama 3.3 on 2026-08-01 ahead of Groq's scheduled 2026-08-16 shutdown.", userVisibleNote: "This model was retired and replaced by GPT-OSS 120B on Groq." },
