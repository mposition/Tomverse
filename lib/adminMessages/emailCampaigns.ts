...
export const adminEmailCampaignsMessages = defineAdminMessages({
  en: {
    ...
    composer: {
      ...
      media: "Tutorial poster",
      mediaPosterUrl: "Poster URL",
      mediaAlt: "Poster alternative text",
      mediaBadge: "Poster label",
      addMedia: "Add tutorial poster",
      removeMedia: "Remove tutorial poster",
  ...
  ko: {
    ...
    composer: {
      ...
      introLabel: "소개",
      media: "사용법 포스터",
      mediaPosterUrl: "포스터 주소",
      mediaAlt: "포스터 대체 텍스트",
      mediaBadge: "포스터 라벨",
      addMedia: "사용법 포스터 추가",
      removeMedia: "사용법 포스터 제거",
