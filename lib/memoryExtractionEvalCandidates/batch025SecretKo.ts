/**
 * Batch 025 — `sensitive_secrets:ko`, third and final batch. **Candidate pool.**
 *
 * 46 cases. The cell stands at 79 (29 adopted plus batch-021), and 46 brings
 ...
 *
 * **Written against the 79 cases the cell already holds.** Batches 005 and 021
 ...
 * `.example` hostnames. Reshaping the value rather than allowlisting the file
 * is this repository's convention: an allowlist here would also cover a real
 * key pasted into this directory later.
 */
...
export const BATCH_025_SECRET_KO: readonly MemoryEvalCase[] = [
    secretKo(1, "생성 요청", [
