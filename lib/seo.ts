...
export const SITE_NAME = "Tomverse";
...
> = {
  ...
  de: {
    title: "Tomverse | Multi-KI-Vergleich und -Prüfung",
    description:
  ...
  es: {
    title: "Tomverse | Comparación y revisión multi-IA",
    description:
  ...
  pt: {
    title: "Tomverse | Comparação e revisão multi-IA",
    description:
