...
/** Media types read as text. Everything else allowed is read as bytes. */
export const MESSAGE_ATTACHMENT_TEXT_TYPES = new Set([
  "text/plain",
  "text/markdown",
  "text/csv",
  "application/json",
...
export const messageAttachmentKindFor = (
  mediaType: string
): MessageAttachmentKind =>
  MESSAGE_ATTACHMENT_TEXT_TYPES.has(mediaType) ? "text" : "file";
